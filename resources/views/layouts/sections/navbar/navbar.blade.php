    ...
    <div class="{{$containerNav}}">
      ...
      @endif
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a href="{{ asset('dokumentumok/Kezikonyv.pdf') }}" target="_blank" class="me-3">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar avatar-online">
              <!--<img src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('assets/img/avatars/0.png') }}" alt class="w-px-40 h-auto rounded-circle">-->
              <img src="{{ Auth::user() ? asset('assets/img/avatars/0.png') : asset('assets/img/avatars/0.png') }}" alt class="w-px-40 h-auto rounded-circle">
            </div>
          </a>
              ...
              <a class="dropdown-item" href="{{ Route::has('profile.show') ? route('profile.show') : 'javascript:void(0);' }}">
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar avatar-online">
                      <img src="{{ Auth::user() ? Auth::user()->profile_photo_url : '' }}" alt class="w-px-40 h-auto rounded-circle">
                    </div>
                  </div>
