...
class StateRequestToComplete implements IStateResponsibility {
    public function isUserResponsible(User $user, IGenericWorkflow $workflow): bool {
        if ($workflow instanceof RecruitmentWorkflow) {
            ...
            Log::error('StateRequestToComplete::isUserResponsible called with invalid workflow type');
            return false;
        }
    }
    ...
    public function getResponsibleUsers(IGenericWorkflow $workflow, bool $notApprovedOnly = false): array
    {
        if ($workflow instanceof RecruitmentWorkflow) {
            ...
            Log::error('StateRequestToComplete::getResponsibleUsers called with invalid workflow type');
            return [];
        }
    }
