...
class RouteServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $moduleNamespace = 'Modules\EmployeeRecruitment\App\Http\Controllers';
    ...
    protected function mapWebRoutes(): void
    {
        Route::middleware('web')
            ...
            ->group(module_path('EmployeeRecruitment', '/routes/web.php'));
    }
    ...
    protected function mapApiRoutes(): void
    {
        Route::prefix('api')
            ->middleware('api')
            ->namespace($this->moduleNamespace)
            ->group(module_path('EmployeeRecruitment', '/routes/api.php'));
    }
}
