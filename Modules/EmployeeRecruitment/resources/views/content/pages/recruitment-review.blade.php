...
@section('content')
    <h4 class="py-3 mb-2">
        <span class="text-muted fw-light">Folyamat újraellenőrzése /</span> Felvételi kérelem
    </h4>
                                    ...
                                    <div id="data-section-1" class="content">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="is_retired" {{ $recruitment->is_retired == 1 ? 'checked' : '' }}>
