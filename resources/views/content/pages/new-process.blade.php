                ...
                <form onSubmit="return false">
                    ...
                    <div id="data-section-1" class="content">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-4">
                                <label for="applicants_female_count" class="col-form-label">Álláshirdetésre jelentkezett nők száma</label>
                                <input class="form-control" type="number" value="18" id="applicants_female_count" />
                            </div>
                            <div class="col-sm-4">
                                <label for="applicants_male_count" class="col-form-label">Álláshirdetésre jelentkezett férfiak száma</label>
