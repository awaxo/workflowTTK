...
class RecruitmentUserPositionTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $recruitUserPosition = RecruitmentUserPosition::factory()->create();

        $this->assertDatabaseHas('recruitment_user_position', [
