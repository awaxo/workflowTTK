                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" id="applicants_female_count" />
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" id="applicants_male_count" />
                                    <span class="ms-2">Fő</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div id="data-section-3" class="content">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" id="base_salary_monthly_gross_1" />
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" id="base_salary_monthly_gross_2" />
                                    <span class="ms-2">Ft</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" value="" id="base_salary_monthly_gross_3" />
                                    <span class="ms-2">Ft</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" value="" id="health_allowance_monthly_gross_4" />
                                    <span class="ms-2">Ft</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" value="" id="management_allowance_monthly_gross_5" />
                                    <span class="ms-2">Ft</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" value="" id="extra_pay_1_monthly_gross_6" />
                                    <span class="ms-2">Ft</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <input class="form-control numeral-mask" type="text" value="" id="extra_pay_2_monthly_gross_7" />
                                    <span class="ms-2">Ft</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
