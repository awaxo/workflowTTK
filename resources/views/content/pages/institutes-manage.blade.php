    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="new_institute" aria-labelledby="new_institute_label">
        ...
        <div class="offcanvas-body mx-0 flex-grow-0">
            <form class="add-new-record pt-0 row g-2 fv-plugins-bootstrap5 fv-plugins-framework" id="form-add-new-record" onsubmit="return false" novalidate="novalidate">
                ...
                <div class="col-sm-12">
                    <button type="button" class="btn btn-primary data-submit me-sm-3 me-1">Mentés</button>
                    <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="offcanvas">Mégse</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="confirm_delete" data-recruitment-id="" class="btn btn-primary">Törlés</button>
                </div>
            </div>
        </div>
    </div>
