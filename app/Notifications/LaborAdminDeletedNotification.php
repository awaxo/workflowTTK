...
class LaborAdminDeletedNotification extends Notification implements ShouldQueue
{
    ...
    /**
     * Workgroups where the user was a labor administrator
     *
     * @var Collection
     */
    protected $laborAdminWorkgroups;
    ...
    public function __construct(
        ...
        $this->user = $user;
        $this->laborAdminWorkgroups = $laborAdminWorkgroups;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $mailMessage = (new MailMessage)
            ->subject('Munkaügyi ügyintéző lezárása')
            ...
            ->line('A felhasználó az alábbi aktív csoportok munkaügyi ügyintézőjeként volt beállítva:')
            ->line('');

        // Add workgroups
        foreach ($this->laborAdminWorkgroups as $workgroup) {
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'labor_admin_workgroups' => $this->laborAdminWorkgroups->map(function ($workgroup) {
                return [
                    'id' => $workgroup->id,
