            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return (
                        ...
                        '<li><a href="javascript:;" class="dropdown-item modify-user" data-bs-toggle="offcanvas" data-bs-target="#new_user">Módosítás</a></li>' +
                        (full.deleted ? '<li><a href="javascript:;" class="dropdown-item restore-user">Visszaállítás</a></li>' : '') +
                        '<div class="dropdown-divider"></div>' +
                        '<li><a href="javascript:;" class="dropdown-item text-danger delete-user">Törlés</a></li>' +
                        '</ul>' +
                        '</div>'
                    );
                }
